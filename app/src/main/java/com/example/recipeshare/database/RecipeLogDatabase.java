    ...
    private static final RoomDatabase.Callback addDefaultRecipes = new RoomDatabase.Callback(){
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db){
            ...
            databaseWriteExecutor.execute(() -> {
                ...
                dao.deleteAll();
                RecipeLog recipe1 = new RecipeLog("PB&J", "1tb Penaut Butter, 1tb Jelly, 2 Slices of bread.", "Spread penaut butter on 1 slice of bread. Spread jelly on other slice of bread. Put both slices together mixing PB&J", "Admin1", true, 1);
                dao.insert(recipe1);

                RecipeLog recipe2 = new RecipeLog("Cereal", "1cup of cereal, 1 cup of milk.", "Put 1 cup of cereal in a bowl. Pour 1 cup of milk into bowl.", "TestUser1", false, 2);
                dao.insert(recipe2);
            });
        }
    };
