    ...
    private static final RoomDatabase.Callback addDefaultRecipes = new RoomDatabase.Callback(){
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db){
            ...
            databaseWriteExecutor.execute(() -> {
                ...
                dao.deleteAll();
                RecipeLog recipe1 = new RecipeLog("PB&J", "1tb Peanut Butter, 1tb Jelly, 2 Slices of bread.", "Spread penaut butter on 1 slice of bread. Spread jelly on other slice of bread. Put both slices together mixing PB&J", "Admin1", 1);
                dao.insert(recipe1);
